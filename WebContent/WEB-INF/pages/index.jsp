...
<head lang="en">
    ...
    <script src="<%=contextPath%>/js/min/verifyFront.js"></script>
...
<div class="content">
    <h3 style="text-align: center;"><img src="<%=contextPath%>/images/logo-f.png" width="330" alt="日照一中校徽"/>工资查询系统</h3>
    ...
    <div class="login-y">
        ...
        <form class="form-horizontal" id="verifyId" action="" method="post">
            <div class="input-group">
                <span class="input-group-addon" id="sizing-addon3">身份证：</span>
                <input type="text" name="teacherId" class="form-control" placeholder="请输入十八位二代身份证" aria-describedby="sizing-addon2" value="">
            </div>
            <br/>

            <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2">密&nbsp;&nbsp;&nbsp;&nbsp;码：</span>
                <input type="password" name="pass" class="form-control" placeholder="请输入密码" aria-describedby="sizing-addon3">
            </div>
            </br>
            <div class="btn-group" style="margin: 0 auto;">
                <button type="button" class="btn btn-success btn-lg">进入查询</button>
                <button type="button" class="btn btn-default btn-lg">修改密码</button>
            </div>
        </form>
...
<!--==footer==-->
<!-- 隐藏域开始 -->
<input type="hidden" name="verifyFlag" id="verifyFlag" value="${verifyFlag}"/>
<!-- 隐藏域结束 -->
</body>
