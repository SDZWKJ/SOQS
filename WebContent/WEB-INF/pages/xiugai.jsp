...
<head lang="en">
    ...
    <!-- Include script -->
    <script src="<%=contextPath%>/js/min/editPass.js"></script>
...
<div id="alertMessage" class="alert alert-danger alert-dismissible" role="alert" style="display: none;">
  ...
  <strong>提示!</strong> <span class="displayText"></span>
</div>
<!-- 提示信息结束 -->
<!--返回顶部 代码 开始 -->
...
<div class="content">
    <h3 style="text-align: center;"><img src="<%=contextPath%>/images/logo-f.png" width="330" alt="日照一中校徽"/>工资查询系统-修改密码</h3>
    ...
    <div class="login-y">
        <form class="form-horizontal" id="editPass" method="post">
            ...
            <div class="input-group">
                ...
                <input type="password" class="form-control" name="confirmPass" placeholder="请再次输入新密码" aria-describedby="sizing-addon3">
            </div>
            </br>
            <div class="btn-group" style="margin: 0 auto;">
                <button type="button" class="btn btn-success btn-lg">确认修改</button>
            </div>
        </form>
    </div>
    <!--==登录框==-->
...
<!-- 隐藏域开始 -->
<input type="hidden" name="alertFlg" id="alertFlg" value="${alertFlg}"/>
<!-- 隐藏域结束 -->
</body>
