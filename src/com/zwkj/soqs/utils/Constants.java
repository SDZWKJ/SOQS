...
public class Constants {
	...
	//-------------------------------------------------------------
	public static final String ALERT_MESSAGE_NOT_SAME = "1";
	public static final String ALERT_MESSAGE_NO_USER = "2";
	public static final String ALERT_MESSAGE_MODIFY_SUCCESS = "3";
	public static final String ALERT_MESSAGE_MODIFY_FAILURE = "4";
